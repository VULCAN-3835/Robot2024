    ...
    public static void updateLEDEffect() {
        switch (actionState){
            ...
            case FLOOR_COLLECTING:
                LEDSubsystem.getInstance().effect = () ->
                        LEDSubsystem.getInstance().classicWaveColor(25, true, ORANGE, 10);
                break;
            case SOURCE_COLLECTING:
                LEDSubsystem.getInstance().effect = () ->
                        LEDSubsystem.getInstance().classicWaveColor(25, false, allianceColor, 10);
                break;
            case AMP_AIMING:
                LEDSubsystem.getInstance().effect = () ->
            ...
            case SPEAKER_SHOOTING:
                LEDSubsystem.getInstance().effect = () ->
                        LEDSubsystem.getInstance().classicWaveColor(50, true, GREEN, 10);
                break;
